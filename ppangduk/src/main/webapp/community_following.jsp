...
.main_menu1, .commu_following {color:#FF9436;}
.commu_following {border-bottom:4px solid #FF9436; padding-bottom:17px;}
.div_menu 
...
.commu_home:hover, .commu_write:hover, .commu_free:hover, .commu_event:hover {color:#FF9436;}
</style>
<body>
