...
.main_menu1, .commu_free {color:#FF9436;}
.commu_free {border-bottom:4px solid #FF9436; padding-bottom:17px;}
.div_menu 
...
.commu_home:hover, .commu_following:hover, .commu_write:hover, .commu_event:hover {color:#FF9436;}
</style>
<body>
