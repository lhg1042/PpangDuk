...
.main_menu1, .commu_write {color:#FF9436;}
.commu_write {border-bottom:4px solid #FF9436; padding-bottom:17px;}
.div_menu 
...
.commu_home:hover, .commu_following:hover, .commu_free:hover, .commu_event:hover {color:#FF9436;}
</style>
<body>
