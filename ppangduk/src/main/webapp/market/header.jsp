...
<div id = "wrap">
	<header>
		<div class="div_image"><a href="../community/community_home.jsp"><img class="image_logo" src="../images/ppangduk_logo.png"></a></div>
		<div class="div_text"><a class="logo_text" href="../community/community_home.jsp"><p>빵덕</p></a></div>

		<table id="table_menu">
			<tr>
				<td><a href="../community/community_home.jsp"><strong class="main_menu1">소통</strong></a></td>
