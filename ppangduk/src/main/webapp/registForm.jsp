...
<style>
	...
	#name, #pw, #confirm_pw, #name, #nick {width:330px; height:35px;}
...
<form action="registerService.jsp" method="post" id="f">
	<div class="div_logo">
		<a href="community_home.jsp"><img class="logo" src="images/ppangduk_logo.png"></a>
	</div>
	...
	<table>
		...
		<tr><td class="field"><input type="password" id="confirm_pw" name="confirm_pw" placeholder="비밀번호 확인" onchange="pwCheck()" style="margin-top:10px"></td></tr>
		...
		<tr><td class="button_td" colspan="2"><input id="regist_button" type="button" value="가입하기" onclick="allCheck()"></td></tr>
